    ...
    <form action="{{ $register_url }}" method="post">
        ...
        <div class="input-group mb-3">
            <input type="text" name="tenant" class="form-control @error('tenant') is-invalid @enderror"
                   value="{{ old('tenant') }}" placeholder="Nome Completo ou Empresa" autofocus>
        ...
        {{-- CPF/CNPJ field --}}
        <div class="input-group mb-3">
            <input type="text" name="cpf_cnpj" class="form-control @error('cpf_cnpj') is-invalid @enderror"
                   value="{{ old('cpf_cnpj') }}" placeholder="CPF ou CNPJ" autofocus>
